...
namespace Toyota
{
    public class AH_VideoAndImage_Extension : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (AH_Nft_Manager_Extension.Instance.PMY_RoomIdFromXanaConstant)
        ...
        IEnumerator UpdateRoomType()
        {
            ...
            switch (AH_Nft_Manager_Extension.Instance.PMY_RoomId)
            {
                case 8:
        ...
        void SetThumbail(string _imageLink)
        {
            ...
            {
                if (AH_Nft_Manager_Extension.Instance && response != null)
                    AH_Nft_Manager_Extension.Instance.NFTLoadedSprites.Add(response);
        ...
        void SetVideo()
        {
            ...
            {
                AH_Nft_Manager_Extension.Instance.videoRenderObject = liveVideoPlayer;
                if (liveVideoPlayer)
            ...
            {
                RenderTexture renderTexture = new RenderTexture(AH_Nft_Manager_Extension.Instance.renderTexture_16x9);
                AH_Nft_Manager_Extension.Instance.videoRenderObject = imgVideo16x9;
            ...
            else if (_videoType == PMY_VideoTypeRes.aws)
            {
                ...
                else if (_imgVideoRatio == PMY_Ratio.NineXSixteenWithDes || _imgVideoRatio == PMY_Ratio.NineXSixteenWithoutDes)
                {
                    if (imgVideo9x16)
                    {
                        ...
                        RenderTexture renderTexture = new RenderTexture(AH_Nft_Manager_Extension.Instance.renderTexture_9x16);
                        renderTexture_temp = renderTexture;
                ...
                else if (_imgVideoRatio == PMY_Ratio.OneXOneWithDes || _imgVideoRatio == PMY_Ratio.OneXOneWithoutDes)
                {
                    if (imgVideo1x1)
                    {
                        ...
                        RenderTexture renderTexture = new RenderTexture(AH_Nft_Manager_Extension.Instance.renderTexture_1x1);
                        renderTexture_temp = renderTexture;
                ...
                else if (_imgVideoRatio == PMY_Ratio.FourXThreeWithDes || _imgVideoRatio == PMY_Ratio.FourXThreeWithoutDes)
                {
                    if (imgVideo4x3)
                    {
                        ...
                        RenderTexture renderTexture = new RenderTexture(AH_Nft_Manager_Extension.Instance.renderTexture_4x3);
                        renderTexture_temp = renderTexture;
            ...
            if (AH_Nft_Manager_Extension.Instance && renderTexture_temp != null)
                AH_Nft_Manager_Extension.Instance.NFTLoadedVideos.Add(renderTexture_temp);
        ...
        public void OpenWorldInfo()
        {
            ...
            if (AH_Nft_Manager_Extension.Instance != null && _videoType != PMY_VideoTypeRes.islive)
            {
                if (GameManager.currentLanguage.Contains("en") && !CustomLocalization.forceJapanese)
                {
                    AH_Nft_Manager_Extension.Instance.SetInfo(_imgVideoRatio, AH_Nft_Manager_Extension.Instance.worldInfos[id].Title[0], AH_Nft_Manager_Extension.Instance.worldInfos[id].Aurthor[0], AH_Nft_Manager_Extension.Instance.worldInfos[id].Des[0], AH_Nft_Manager_Extension.Instance.worldInfos[id].url, _texture, AH_Nft_Manager_Extension.Instance.worldInfos[id].Type, AH_Nft_Manager_Extension.Instance.worldInfos[id].VideoLink, AH_Nft_Manager_Extension.Instance.worldInfos[id].videoType,
                        AH_Nft_Manager_Extension.Instance.worldInfos[id].pdfURL, AH_Nft_Manager_Extension.Instance.worldInfos[id].quiz_data, id, roomType);
                }
                else if (CustomLocalization.forceJapanese || GameManager.currentLanguage.Equals("ja"))
                {
                    AH_Nft_Manager_Extension.Instance.SetInfo(_imgVideoRatio, AH_Nft_Manager_Extension.Instance.worldInfos[id].Title[1], AH_Nft_Manager_Extension.Instance.worldInfos[id].Aurthor[1], AH_Nft_Manager_Extension.Instance.worldInfos[id].Des[1], AH_Nft_Manager_Extension.Instance.worldInfos[id].url, _texture, AH_Nft_Manager_Extension.Instance.worldInfos[id].Type, AH_Nft_Manager_Extension.Instance.worldInfos[id].VideoLink, AH_Nft_Manager_Extension.Instance.worldInfos[id].videoType,
                        AH_Nft_Manager_Extension.Instance.worldInfos[id].pdfURL, AH_Nft_Manager_Extension.Instance.worldInfos[id].quiz_data, id, roomType);
