...
public class UserRolesView : MonoBehaviour
{
    ...
    public void OnUserRolesPanelOpen()
    {
       ...
       // userRolesAnim.transform.DOMoveY(userRoleButtonMainObj.transform.position.y - 105, 0);
        ...
        FeedUIController.Instance.footerCan.GetComponent<HomeFooterTabCanvas>().canvasGroup.interactable = false;
    }
    ...
    IEnumerator ClosePanel()
    {
        ...
        FeedUIController.Instance.footerCan.GetComponent<HomeFooterTabCanvas>().canvasGroup.interactable = true;
    }
