...
public class NpcAssetLoader : MonoBehaviour
{
    ...
    private void WearDefault(string type)
    {
        ...
        {
            case "Chest":
                StichItem(AvatarPropertiesDatabase.instance.DefaultShirt, "Chest", this.gameObject, false);
                break;
            case "Legs":
                StichItem(AvatarPropertiesDatabase.instance.DefaultPent, "Legs", this.gameObject, false);
                break;
            case "Feet":
                StichItem(AvatarPropertiesDatabase.instance.DefaultShoes, "Feet", this.gameObject, false);
                break;
            case "Hair":
                StichItem(AvatarPropertiesDatabase.instance.DefaultHair, "Hair", this.gameObject, false);
                break;
            default:
                break;
        }
