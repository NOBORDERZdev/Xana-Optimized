...
public class DoorKeyComponent : ItemComponent
{
    ...
    private void CollisionEnter()
    {
        ...
        var _other = GamificationComponentData.instance.buildingDetect.GetComponent<KeyValues>();
        ...
        if (this.doorKeyComponentData.isKey && !this.doorKeyComponentData.isDoor)
        {
            ...
            _other._dooKeyValues.Add(this.doorKeyComponentData.selectedKey);
