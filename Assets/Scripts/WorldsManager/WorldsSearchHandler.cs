...
public class WorldsSearchHandler : MonoBehaviour, IEnhancedScrollerDelegate
{
    public WorldsHandler worldManagerRef;
    /// <summary>
    ...
    public void LoadData(int pageStartIndex)
    {
        ...
        foreach (WorldItemDetail world in worldManagerRef.resultWorldList)
        {
            _data.Add(world);
        }
