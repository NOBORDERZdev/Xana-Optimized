...
public class LoadAndShowNFTHandler : MonoBehaviour
{
    ...
    public NFTScrollHandler scrollActivityNFTRef;
    ...
    public void TaskOnClick()
    {
        ...
        NFTDetailSlider = SNS_NFTHandler.Instance.ScrollerObj;
        ...
        {
            if (SNS_NFTHandler.Instance.EquipCollectionAddresses.Contains(_OwnedNFTDataObj.CollectionAddress[_indexNumber]))
            {
                //  NFTDetailSlider.GetComponent<NFTScrollHandler>()._AttributeData = UserRegisterationManager.instance._web3APIforWeb2._OwnedNFTDataObj._Attributes[_indexNumber];
            ...
            else if (SNS_NFTHandler.Instance.ComingSoonCollectionAddresses.Contains(_OwnedNFTDataObj.CollectionAddress[_indexNumber]))
            {
        ...
        {
            if (SNS_NFTHandler.Instance.TestnetEquipCollectionAddresses.Contains(_OwnedNFTDataObj.CollectionAddress[_indexNumber]))
            {
                if (_OwnedNFTDataObj.NFTlistdata.list[_indexNumber].nftId == PlayerPrefs.GetInt("nftID"))
                {
                    scrollActivityNFTRef.SubButtonText.text = "Unequip";
                ...
                //  NFTDetailSlider.GetComponent<NFTScrollHandler>()._AttributeData = NFTClass.attribute;
                scrollActivityNFTRef._NFTID = _OwnedNFTDataObj.NFTlistdata.list[_indexNumber].nftId;
            }
            else if (SNS_NFTHandler.Instance.TestnetComingSoonCollectionAddresses.Contains(_OwnedNFTDataObj.CollectionAddress[_indexNumber]))
            {
                scrollActivityNFTRef.SubButtonText.text = "Coming Soon";
                scrollActivityNFTRef.subButtonTextToCheck = "Coming Soon";
            }
