...
public class InputFieldHightSetter : MonoBehaviour
{
    ...
    IEnumerator WaitToResetContentSizeFitter()
    {
        ...
        // MyProfileManager.Instance.editProfilemainInfoPart.GetComponent<ContentSizeFitter>().verticalFit = ContentSizeFitter.FitMode.Unconstrained;
        yield return new WaitForSeconds(0.1f);
        //MyProfileManager.Instance.editProfilemainInfoPart.GetComponent<ContentSizeFitter>().verticalFit = ContentSizeFitter.FitMode.PreferredSize;
    }
