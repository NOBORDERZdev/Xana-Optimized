...
public class SNS_SMSModuleManager : MonoBehaviour
{
    public static SNS_SMSModuleManager Instance;
    ...
    public SNSChatUIHandler sNSChatView;
    ...
    public SearchHandler searchManagerAllConversation;
    public SearchHandler searchManagerFindFriends;
    ...
    IEnumerator WaitToStartCallForMessageScene()
    {
       ...
       Debug.Log("SNS_SMSModuleManager isLoginFromDifferentId:" + SNS_APIResponseManager.Instance.isLoginFromDifferentId);
    ...
    public void OnClickChatScreenBackButton()
    {
        ...
        ChatScreenData.Instance.allChatGetConversationDatum = null;
        currentConversationData = null;
        allChatGetConversationDatum = null;
        ChatScreen.SetActive(false);        
        MessageListScreen.SetActive(true);
