...
namespace DynamicScrollRect
{
    ...
    public class ScrollContent : MonoBehaviour
    {
        ...
        public GameObject _FirstAvatar;
        ...
        public ScrollItem _referenceItem;
        ...
        public List<ScrollItem> _activatedItems = new List<ScrollItem>();

        public List<ScrollItem> _deactivatedItems = new List<ScrollItem>();
        ...
        {
            //ContentList.Clear();
            //foreach (Transform contentAvatars in _Content.transform)
            //{
            //    ContentList.Add(contentAvatars);
            //}

            //for (int i = 0; i < ContentList.Count; i++)
            //{
            //    //ContentList[i] = DynamicScrollRect.content.GetChild(i).transform;
            //    ContentList[i].GetComponent<Image>().sprite = DynamicScrollRect.avatarData[i].GetComponent<Image>().sprite;
            //}
