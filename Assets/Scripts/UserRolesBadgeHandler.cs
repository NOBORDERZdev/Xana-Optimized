...
public class UserRolesBadgeHandler : MonoBehaviour
{
    [SerializeField]
    ...
    {
        if (ConstantsGod.UserPriorityRole.Equals("Guest") || ConstantsGod.UserPriorityRole.Equals("free")) return;
       ...
       // userRolesAnim.transform.DOMoveY(userRoleButtonMainObj.transform.position.y - 105, 0);
        ...
        FeedsManager.Instance.footerCan.GetComponent<HomeFooterTabCanvas>().canvasGroup.interactable = false;
    }
    ...
    IEnumerator ClosePanel()
    {
        ...
        FeedsManager.Instance.footerCan.GetComponent<HomeFooterTabCanvas>().canvasGroup.interactable = true;
    }
