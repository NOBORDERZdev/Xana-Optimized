...
public class BGFilterHandler : MonoBehaviour
{

    //public PostProcessProfile profile;
    public GameObject contentCategoryPanel;
    public GameObject categoryPrefab;
    public static BGFilterHandler instance;
    ...
    public void OnClickFilterItem(byte r, byte g, byte b, byte a)
    {
        ...
        // VideoRoomHandler.Instance.mainVolume.profile = profile;
        ...
        else
        {
            ...
            if (!bean.Equals("") || !bean.Equals(null))
            {
                ...
                for (int i = 0; i < bean.data.filter.Count; i++)
                {
                    ...
                    ARBackgroundItem LBC = categoryObject.GetComponent<ARBackgroundItem>();

                    if (LBC == null)
                    {
                        LBC = categoryObject.AddComponent<ARBackgroundItem>();
                    }
