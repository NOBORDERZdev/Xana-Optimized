...
namespace XanaAi
{
    public class AiManager : MonoBehaviour
    {
        ...
        private AvatarBodyParts charcterBody;
        [SerializeField]
        ...
        void WearDefault(string type, AiController ai)
        {
            ...
            {
                case "Chest":
                    ai.StichItem(-1, AvatarPropertiesDatabase.instance.DefaultShirt, "Chest", ai.gameObject, false);
                    break;
                case "Legs":
                    ai.StichItem(-1, AvatarPropertiesDatabase.instance.DefaultPent, "Legs", ai.gameObject, false);
                    break;
                case "Feet":
                    ai.StichItem(-1, AvatarPropertiesDatabase.instance.DefaultShoes, "Feet", ai.gameObject, false);
                    break;
                case "Hair":
                    ai.StichItem(-1, AvatarPropertiesDatabase.instance.DefaultHair, "Hair", ai.gameObject, false);
                    break;
                default:
                    break;
        ...
        public IEnumerator DownloadAddressableTexture(string key, string ObjectType, AiController ai)
        {
            ...
            AvatarBodyParts charcterBody = ai.GetComponent<AvatarBodyParts>();
            if (Application.internetReachability != NetworkReachability.NotReachable)
            {
                try
                {
