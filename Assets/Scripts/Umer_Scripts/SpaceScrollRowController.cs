...
public class SpaceScrollRowController : EnhancedScrollerCellView, IEnhancedScrollerDelegate
{
    ...
    /// </summary>
    private SpaceScrollRowHandler _data;
    ...
    public void SetData(SpaceScrollRowHandler data)
    {
    ...
    public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
    {
        ...
        WorldItemView detailCellView = scroller.GetCellView(detailCellViewPrefab) as WorldItemView;
        ...
        detailCellView.InitItem(_data.childData[dataIndex]);
