...
namespace NatCorder.Internal {
    ...
    public static class MediaRecorderBridge {
        ...
        #else
        public static IntPtr CreateMP4Recorder (int width, int height, float framerate, int bitrate, int keyframeInterval, int sampleRate, int channelCount) => IntPtr.Zero;
        public static IntPtr CreateHEVCRecorder (int width, int height, float framerate, int bitrate, int keyframeInterval, int sampleRate, int channelCount) => IntPtr.Zero;
        public static IntPtr CreateGIFRecorder (int width, int height, float frameDuration) => IntPtr.Zero;
