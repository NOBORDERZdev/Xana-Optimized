...
public class PhotonConnector : MonoBehaviourPunCallbacks, IOnEventCallback
{
    ...
    public override void OnConnectedToMaster()
    {
        ...
        playerProperties.Add("NFTURL", XanaConstantsHolder.xanaConstants.NFTUrl);
        playerProperties.Add("ClothJson", XanaConstantsHolder.xanaConstants.clothJson);
    ...
    protected virtual void RaiseOnInitializationError()
    {
        ...
        {
            this.RaiseOnPlayerDisconnectedFromMatch(null);
        }
        PhotonNetwork.ConnectUsingSettings();
    }
