...
public class DefaultBattleGUI : BattleGUI
{
    ...
    protected virtual string SetStringValues(string msg, ControlsScript controlsScript)
    {
        ...
        if (character != null)
        {
            ...
            {
                string[] characterNameArray = character.characterName.Split(" ");
                characterName = characterNameArray[0];
            }
            //msg = msg.Replace("%character%", character.characterName);
            msg = msg.Replace("%character%", characterName);
        }
    ...
    protected override void OnGameBegin(ControlsScript cPlayer1, ControlsScript cPlayer2, StageOptions stage)
    {
        ...
        if (this.player1GUI != null && this.player1GUI.name != null)
        {
            ...
            else
            {
                ...
                {
                    this.player1GUI.name.text = GetFirstNameOfPlayer(FightingGameManager.instance.player1Data.name.ToUpper());
                }
                else
                {
                    this.player1GUI.name.text = GetFirstNameOfPlayer(FightingGameManager.instance.player2Data.name.ToUpper());
                }
            }
        }
        ...
        if (this.player2GUI != null && this.player2GUI.name != null)
        {
            ...
            if (UFE.gameMode == GameMode.TrainingRoom)
            {
                this.player2GUI.name.text = GetFirstNameOfPlayer(ConstantsHolder.xanaConstants.defaultFightingName.ToUpper());
            }
            else if (UFE.gameMode == GameMode.VersusMode)
            {
                this.player2GUI.name.text = GetFirstNameOfPlayer(ConstantsHolder.xanaConstants.defaultFightingName.ToUpper());
            ...
            else
            {
                ...
                {
                    this.player2GUI.name.text = GetFirstNameOfPlayer(FightingGameManager.instance.player1Data.name.ToUpper());
                }
                else
                {
                    this.player2GUI.name.text = GetFirstNameOfPlayer(FightingGameManager.instance.player2Data.name.ToUpper());
                }
            }
        }
        ...
        if (this.player1GUI != null && this.player1GUI.portrait != null)
        {
            if (cPlayer1.myInfo.profilePictureSmall != null)
            {
                ...
                /*if (UFE.gameMode == GameMode.TrainingRoom)
				{
					setPlayerIcon(ConstantsHolder.xanaConstants.NFTUrl, this.player1GUI.portrait);
                }
                else if (UFE.gameMode==GameMode.VersusMode)
                {
					setPlayerIcon(ConstantsHolder.xanaConstants.NFTUrl, this.player1GUI.portrait);
        ...
        if (this.player2GUI != null && this.player2GUI.portrait != null)
        {
            if (cPlayer2.myInfo.profilePictureSmall != null)
            {
                ...
                /*if (UFE.gameMode == GameMode.TrainingRoom)
				{
					setPlayerIcon(ConstantsHolder.xanaConstants.defaultFightingNFTUrl, this.player2GUI.portrait);
				}
                else if (UFE.gameMode==GameMode.VersusMode)
                {
					setPlayerIcon(ConstantsHolder.xanaConstants.defaultFightingNFTUrl, this.player2GUI.portrait);
    ...
    protected override void OnNewAlert(string msg, ControlsScript player)
    {
        ...
        if (player != null)
        {
            Debug.LogError("msg: " + msg + "ProcessMessage: " + ProcessMessage(msg, player));
        ...
        else
        {
            ...
            Debug.LogError("message: " + msg + " processedMessage: " + processedMessage);
