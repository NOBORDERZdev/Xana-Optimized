...
public class UFE : MonoBehaviour, UFEInterface
{
	...
	protected void Awake(){
		...
		UFE.SetMusicVolume(PlayerPrefs.GetFloat(UFE.MusicVolumeKey, 0.5f));
		UFE.SetSoundFX(PlayerPrefs.GetInt(UFE.SoundsEnabledKey, 1) > 0);
		UFE.SetSoundFXVolume(PlayerPrefs.GetFloat(UFE.SoundsVolumeKey, 0.5f));
    }
        ...
        foreach (MoveSetData moveSet in loadedMoveSets)
        {
            foreach (MoveInfo move in moveSet.attackMoves)
            {
				...
				if (player == 1)
				{
					switch (move.moveName)
					{
						case "Heavy Punch":
							...
							ChangeStats(move, FightingDataManager.Instance.player1.punch, FightingDataManager.Instance.player2.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Light Punch":
							ChangeStats(move, 20, FightingDataManager.Instance.player2.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Power Hit":
							ChangeStats(move, FightingDataManager.Instance.player1.special_move, FightingDataManager.Instance.player2.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Heavy Kick":
							ChangeStats(move, FightingDataManager.Instance.player1.kick, FightingDataManager.Instance.player2.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Standing Light Kick":
							ChangeStats(move, 25, FightingDataManager.Instance.player2.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						default:
							break;
					}
				...
				else if (player == 2)
				{
					...
					{
						case "Heavy Punch":
							ChangeStats(move, FightingDataManager.Instance.player2.punch, FightingDataManager.Instance.player1.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Light Punch":
							ChangeStats(move, 20, FightingDataManager.Instance.player1.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Power Hit":
							ChangeStats(move, FightingDataManager.Instance.player2.special_move, FightingDataManager.Instance.player1.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Heavy Kick":
							ChangeStats(move, FightingDataManager.Instance.player2.kick, FightingDataManager.Instance.player1.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						case "Standing Light Kick":
							ChangeStats(move, 25, FightingDataManager.Instance.player1.defence);//instead of 300f put value taken from sheet and replace 50f with opponent defense value
							break;
						default:
							break;
					}
	...
	//Attizaz
	static void ChangeStats(MoveInfo move, float powerValue, float defenseValue) {
	 float percentRequired = 0.45f;
	 move.hits[0]._damageOnHit = powerValue;
	 move.hits[0]._damageOnBlock = defenseValue*percentRequired;
	}
	/////
