...
[System.Serializable]
    ...
    public class NounceClass
    {
        ...
        public NounceClass NounceClassFtn( string _pubAddress , string _nonce)
        {
            NounceClass obj1 = new NounceClass();
             obj1.walletAddress = _pubAddress;
            print("_nonce in local class is : " + _nonce);
             obj1.nonce = _nonce;
             return obj1;
        }
    }
 ...
 [Serializable]
    ...
    public class VerifySignedMsgClass
    {
        ...
        public VerifySignedMsgClass VerifySignedClassFtn(string _nonce , string _Signature , string _deviceIDs)
        {
            VerifySignedMsgClass obj1 = new VerifySignedMsgClass();
            obj1.nonce = _nonce;
            obj1.signature = _Signature;
            obj1.deviceId = _deviceIDs;
            return obj1;
        }  
     }  
