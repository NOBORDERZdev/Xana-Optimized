...
public class WebViewManager : MonoBehaviour
{
    ...
    [Space(10)]
    public Button LoginOptionEmailBtn;
    public Button LoginOptionWalletBtn;
    public Button LoginOptionAppleBtn;
    public Button LoginOptionGoogleBtn;

    public bool WebViewBool;
    private void Awake()
    {
    ...
    public void StartwebView(string webURL)
    {
        Url = webURL;
    ...
    private void Update()
    {
        if (webViewObject != null)
        {
            ...
            {
                LoginOptionEmailBtn.interactable = true;
                LoginOptionWalletBtn.interactable = true;
                LoginOptionAppleBtn.interactable = true;
                LoginOptionGoogleBtn.interactable = true;
                CloseWebView();
            }
        }
    }
    ...
    public IEnumerator ShowWebView()
    {
        ...
        //webViewObject.SetMargins((Screen.width / 2) + (Screen.width / 4), Screen.height / 4, 50, Screen.height / 4);
