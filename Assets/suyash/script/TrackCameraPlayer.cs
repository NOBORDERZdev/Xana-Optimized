...
{
    internal class TrackCameraPlayerDataDescription
    {
        ...
        internal struct PoseData
        {
            ...
            public List<TrackCameraPlayer.TrackedPose> Poses;
        }
        ...
        internal static List<PoseData> DeviceData = new List<PoseData>
        {
            ...
            new PoseData
            {
                ...
                Poses = new List<TrackCameraPlayer.TrackedPose>
                {
                    TrackCameraPlayer.TrackedPose.LeftEye,
                    TrackCameraPlayer.TrackedPose.RightEye,
                    TrackCameraPlayer.TrackedPose.Center,
                    TrackCameraPlayer.TrackedPose.Head,
                    TrackCameraPlayer.TrackedPose.ColorCamera
                }
            },
            // generic controller
            new PoseData
            {
                ...
                Poses = new List<TrackCameraPlayer.TrackedPose>
                {
                    TrackCameraPlayer.TrackedPose.LeftPose,
                    TrackCameraPlayer.TrackedPose.RightPose
                }
            },
            // generic remote
            new PoseData
            {
                ...
                Poses = new List<TrackCameraPlayer.TrackedPose>
                {
                    TrackCameraPlayer.TrackedPose.RemotePose,
                }
            },
        };
    }
    ...
    public static class PoseDataSource
    {
        ...
        public static bool TryGetDataFromSource(TrackCameraPlayer.TrackedPose poseSource, out Pose resultPose)
        {
        ...
        public static PoseDataFlags GetDataFromSource(TrackCameraPlayer.TrackedPose poseSource, out Pose resultPose)
        {
#if ENABLE_AR || ENABLE_VR
            switch (poseSource)
            {
                case TrackCameraPlayer.TrackedPose.RemotePose:
                    {
                ...
                case TrackCameraPlayer.TrackedPose.LeftEye:
                    {
                        return GetNodePoseData(XR.XRNode.LeftEye, out resultPose);
                    }
                case TrackCameraPlayer.TrackedPose.RightEye:
                    {
                        return GetNodePoseData(XR.XRNode.RightEye, out resultPose);
                    }
                case TrackCameraPlayer.TrackedPose.Head:
                    {
                        return GetNodePoseData(XR.XRNode.Head, out resultPose);
                    }
                case TrackCameraPlayer.TrackedPose.Center:
                    {
                        return GetNodePoseData(XR.XRNode.CenterEye, out resultPose);
                    }
                case TrackCameraPlayer.TrackedPose.LeftPose:
                    {
                        return GetNodePoseData(XR.XRNode.LeftHand, out resultPose);
                    }
                case TrackCameraPlayer.TrackedPose.RightPose:
                    {
                        return GetNodePoseData(XR.XRNode.RightHand, out resultPose);
                    }
                case TrackCameraPlayer.TrackedPose.ColorCamera:
                    {
    ...
    // The DefaultExecutionOrder is needed because TrackCameraPlayer does some
    ...
    /// <summary>
    /// The TrackCameraPlayer component applies the current Pose value of a tracked device to the transform of the GameObject.
    /// TrackCameraPlayer can track multiple types of devices including XR HMDs, controllers, and remotes.
    /// </summary>
    ...
    public class TrackCameraPlayer : MonoBehaviour
    {
        ...
        /// <summary>
        /// The list of endpoints that users can track with the <see cref="TrackCameraPlayer"/>
        /// </summary>
        ...
        DeviceType m_Device;
        /// <summary>
        /// This is used to indicate which pose the TrackCameraPlayer is currently tracking.
        /// </summary>
        ...
        [SerializeField]
        TrackedPose m_PoseSource = TrackCameraPlayer.TrackedPose.Center;
        /// <summary>
        ...
        /// <summary>
        /// This method is used to set the device / pose pair for the SpatialTracking.TrackCameraPlayer. setting an invalid combination of these values will return false.
        /// </summary>
        ...
        {
            if ((int)deviceType < TrackCameraPlayerDataDescription.DeviceData.Count)
            {
                TrackCameraPlayerDataDescription.PoseData val = TrackCameraPlayerDataDescription.DeviceData[(int)deviceType];
        ...
        /// the TrackCameraPlayer. When this field is empty, the TrackCameraPlayer will operate as per usual, with pose data being
        /// retrieved from the device or pose settings of the TrackCameraPlayer. When this field is set, the pose data will be
        ...
        /// <summary>
        ///  This is used to indicate whether the TrackCameraPlayer will use the object's original transform as its basis.
        /// </summary>
        ...
        /// <summary>
        /// Sets the transform that is being driven by the <see cref="TrackCameraPlayer"/>. will only correct set the rotation or position depending on the <see cref="PoseDataFlags"/>
        /// </summary>
        ...
        protected virtual void SetLocalTransform(Vector3 newPosition, Quaternion newRotation, PoseDataFlags poseFlags)
        {
                ...
                (poseFlags & PoseDataFlags.Rotation) > 0)
            {
                ...
                // _camera.localRotation = newRotation; /*new Quaternion(transform.localRotation.x, newRotation.y, transform.localRotation.z, transform.localRotation.w);*/
                _camera.localRotation = new Quaternion(newRotation.x, 0, newRotation.z, newRotation.w);
