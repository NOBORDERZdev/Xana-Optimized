...
Shader "Mameshiba Games/Standard_Triplanar"
{
	Properties
	{
		...
		[ASEBegin][SingleLineTexture]_MainTex("Main Texture", 2D) = "white" {}
		...
		[ASEEnd]_TopSize("Top Size", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float2 _Tiling;
			float2 _Offset;
			float2 _TriplanarTiling;
			float2 _TriplanarOffset;
			float _Falloff;
			float _TopSize;
			float _DetailNormalMapScale;
			float _BumpScale;
			float _TriplanarNormalMapScale;
			float _SmoothnessTextureChannel;
			float _TriplanarSmoothness;
			...
			SAMPLER(sampler_TriplanarAlbedo);
			TEXTURE2D(_White);
			TEXTURE2D(_Black);
			SAMPLER(sampler_White);
			SAMPLER(sampler_Black);
			TEXTURE2D(_TopPattern);
			SAMPLER(sampler_TopPattern);
			TEXTURE2D(_DetailNormalMap);
			TEXTURE2D(_BumpMap);
			SAMPLER(sampler_BumpMap);
			TEXTURE2D(_TriplanarNormalMap);
			SAMPLER(sampler_TriplanarNormalMap);
			TEXTURE2D(_MetallicGlossMap);
			SAMPLER(sampler_MetallicGlossMap);
			TEXTURE2D(_TriplanarMetallic);
			SAMPLER(sampler_TriplanarMetallic);
			...
			inline float4 TriplanarSampling26( TEXTURE2D(topTexMap), SAMPLER(samplertopTexMap), TEXTURE2D(midTexMap), SAMPLER(samplermidTexMap), TEXTURE2D(botTexMap), SAMPLER(samplerbotTexMap), float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord25_g51 = IN.ase_texcoord8.xy * _DetailTiling + _DetailOffset;
				float2 texCoord18_g51 = IN.ase_texcoord8.xy * _Tiling + _Offset;
				float4 tex2DNode1_g51 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, texCoord18_g51 );
				float2 texCoord43 = IN.ase_texcoord8.xy * _TriplanarTiling + _TriplanarOffset;
				float4 triplanar26 = TriplanarSampling26( _White, sampler_White, _Black, sampler_Black, _Black, sampler_Black, WorldPosition, WorldNormal, _Falloff, float2( 1,1 ), float3( 1,1,1 ), float3(0,0,0) );
				float localStochasticTiling53_g49 = ( 0.0 );
				float2 temp_cast_0 = (_TopSize).xx;
				float2 temp_output_104_0_g49 = temp_cast_0;
				float3 temp_output_80_0_g49 = WorldPosition;
				float2 Triplanar_UV050_g49 = ( temp_output_104_0_g49 * (temp_output_80_0_g49).zy );
				float2 UV53_g49 = Triplanar_UV050_g49;
				float2 UV153_g49 = float2( 0,0 );
				float2 UV253_g49 = float2( 0,0 );
				float2 UV353_g49 = float2( 0,0 );
				float W153_g49 = 0.0;
				float W253_g49 = 0.0;
				float W353_g49 = 0.0;
				StochasticTiling( UV53_g49 , UV153_g49 , UV253_g49 , UV353_g49 , W153_g49 , W253_g49 , W353_g49 );
				float2 temp_output_57_0_g49 = ddx( Triplanar_UV050_g49 );
				float2 temp_output_58_0_g49 = ddy( Triplanar_UV050_g49 );
				float localTriplanarWeights108_g49 = ( 0.0 );
				float3 WorldNormal108_g49 = WorldNormal;
				float W0108_g49 = 0.0;
				float W1108_g49 = 0.0;
				float W2108_g49 = 0.0;
				TriplanarWeights( WorldNormal108_g49 , W0108_g49 , W1108_g49 , W2108_g49 );
				float localStochasticTiling83_g49 = ( 0.0 );
				float2 Triplanar_UV164_g49 = ( temp_output_104_0_g49 * (temp_output_80_0_g49).zx );
				float2 UV83_g49 = Triplanar_UV164_g49;
				float2 UV183_g49 = float2( 0,0 );
				float2 UV283_g49 = float2( 0,0 );
				float2 UV383_g49 = float2( 0,0 );
				float W183_g49 = 0.0;
				float W283_g49 = 0.0;
				float W383_g49 = 0.0;
				StochasticTiling( UV83_g49 , UV183_g49 , UV283_g49 , UV383_g49 , W183_g49 , W283_g49 , W383_g49 );
				float2 temp_output_86_0_g49 = ddx( Triplanar_UV164_g49 );
				float2 temp_output_92_0_g49 = ddy( Triplanar_UV164_g49 );
				float localStochasticTiling117_g49 = ( 0.0 );
				float2 Triplanar_UV271_g49 = ( temp_output_104_0_g49 * (temp_output_80_0_g49).xy );
				float2 UV117_g49 = Triplanar_UV271_g49;
				float2 UV1117_g49 = float2( 0,0 );
				float2 UV2117_g49 = float2( 0,0 );
				float2 UV3117_g49 = float2( 0,0 );
				float W1117_g49 = 0.0;
				float W2117_g49 = 0.0;
				float W3117_g49 = 0.0;
				StochasticTiling( UV117_g49 , UV1117_g49 , UV2117_g49 , UV3117_g49 , W1117_g49 , W2117_g49 , W3117_g49 );
				float2 temp_output_107_0_g49 = ddx( Triplanar_UV271_g49 );
				float2 temp_output_110_0_g49 = ddy( Triplanar_UV271_g49 );
				float4 Output_Triplanar295_g49 = ( ( ( ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV153_g49, temp_output_57_0_g49, temp_output_58_0_g49 ) * W153_g49 ) + ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV253_g49, temp_output_57_0_g49, temp_output_58_0_g49 ) * W253_g49 ) + ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV353_g49, temp_output_57_0_g49, temp_output_58_0_g49 ) * W353_g49 ) ) * W0108_g49 ) + ( W1108_g49 * ( ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV183_g49, temp_output_86_0_g49, temp_output_92_0_g49 ) * W183_g49 ) + ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV283_g49, temp_output_86_0_g49, temp_output_92_0_g49 ) * W283_g49 ) + ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV383_g49, temp_output_86_0_g49, temp_output_92_0_g49 ) * W383_g49 ) ) ) + ( W2108_g49 * ( ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV1117_g49, temp_output_107_0_g49, temp_output_110_0_g49 ) * W1117_g49 ) + ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV2117_g49, temp_output_107_0_g49, temp_output_110_0_g49 ) * W2117_g49 ) + ( SAMPLE_TEXTURE2D_GRAD( _TopPattern, sampler_TopPattern, UV3117_g49, temp_output_107_0_g49, temp_output_110_0_g49 ) * W3117_g49 ) ) ) );
				float4 temp_output_58_0 = ( triplanar26 * Output_Triplanar295_g49 );
				float4 lerpResult27 = lerp( ( ( SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_linear_repeat, texCoord25_g51 ) * unity_ColorSpaceDouble ) * _Color * tex2DNode1_g51 ) , SAMPLE_TEXTURE2D( _TriplanarAlbedo, sampler_TriplanarAlbedo, texCoord43 ) , temp_output_58_0);
				
				float3 unpack21_g51 = UnpackNormalScale( SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_linear_repeat, texCoord25_g51 ), _DetailNormalMapScale );
				unpack21_g51.z = lerp( 1, unpack21_g51.z, saturate(_DetailNormalMapScale) );
				float3 unpack2_g51 = UnpackNormalScale( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, texCoord18_g51 ), _BumpScale );
				unpack2_g51.z = lerp( 1, unpack2_g51.z, saturate(_BumpScale) );
				float3 tex2DNode2_g51 = unpack2_g51;
				float3 unpack39 = UnpackNormalScale( SAMPLE_TEXTURE2D( _TriplanarNormalMap, sampler_TriplanarNormalMap, texCoord43 ), _TriplanarNormalMapScale );
				unpack39.z = lerp( 1, unpack39.z, saturate(_TriplanarNormalMapScale) );
				float3 lerpResult31 = lerp( BlendNormal( unpack21_g51 , tex2DNode2_g51 ) , unpack39 , temp_output_58_0.xyz);
				
				float4 tex2DNode5_g51 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_MetallicGlossMap, texCoord18_g51 );
				float4 tex2DNode46 = SAMPLE_TEXTURE2D( _TriplanarMetallic, sampler_TriplanarMetallic, texCoord43 );
				float lerpResult45 = lerp( tex2DNode5_g51.r , tex2DNode46.r , temp_output_58_0.x);
				
				float lerpResult50 = lerp( ( tex2DNode5_g51.a * _SmoothnessTextureChannel ) , ( tex2DNode46.a * _TriplanarSmoothness ) , temp_output_58_0.x);
				

				float3 BaseColor = lerpResult27.rgb;
				float3 Normal = lerpResult31;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = lerpResult45;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord25_g51 = IN.ase_texcoord4.xy * _DetailTiling + _DetailOffset;
				float2 texCoord18_g51 = IN.ase_texcoord4.xy * _Tiling + _Offset;
				float4 tex2DNode1_g51 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, texCoord18_g51 );
				float2 texCoord43 = IN.ase_texcoord4.xy * _TriplanarTiling + _TriplanarOffset;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float4 triplanar26 = TriplanarSampling26( _White, sampler_White, _Black, sampler_Black, _Black, sampler_Black, WorldPosition, ase_worldNormal, _Falloff, float2( 1,1 ), float3( 1,1,1 ), float3(0,0,0) );
				float localStochasticTiling53_g49 = ( 0.0 );
				float2 temp_cast_0 = (_TopSize).xx;
				float2 temp_output_104_0_g49 = temp_cast_0;
				float3 temp_output_80_0_g49 = WorldPosition;
				...
				float2 temp_output_58_0_g49 = ddy( Triplanar_UV050_g49 );
				float localTriplanarWeights108_g49 = ( 0.0 );
				float3 WorldNormal108_g49 = ase_worldNormal;
				float W0108_g49 = 0.0;
				float W1108_g49 = 0.0;
				float W2108_g49 = 0.0;
				TriplanarWeights( WorldNormal108_g49 , W0108_g49 , W1108_g49 , W2108_g49 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord25_g51 = IN.ase_texcoord2.xy * _DetailTiling + _DetailOffset;
				float2 texCoord18_g51 = IN.ase_texcoord2.xy * _Tiling + _Offset;
				float4 tex2DNode1_g51 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, texCoord18_g51 );
				float2 texCoord43 = IN.ase_texcoord2.xy * _TriplanarTiling + _TriplanarOffset;
...
/*ASEBEGIN
Version=19002
1624;357;1413;656;2351.564;491.044;1.666947;True;False
...
Node;AmplifyShaderEditor.TriplanarNode;26;-1118.767,94.57541;Inherit;True;Cylindrical;World;False;Top Texture 0;_TopTexture0;white;18;None;Mid Texture 0;_MidTexture0;white;21;None;Bot Texture 0;_BotTexture0;white;19;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT3;1,1,1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;99;-798.8596,-313.6611;Inherit;False;Builtin Material;0;;51;60f6c6f9fe3c1dc4187a8a52aa0c9efd;0;0;8;COLOR;0;COLOR;36;FLOAT3;10;FLOAT3;35;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;16
Node;AmplifyShaderEditor.FunctionNode;52;-983.033,466.6556;Inherit;True;Procedural Sample;-1;;49;f5379ff72769e2b4495e5ce2f004d8d4;2,157,2,315,2;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,1;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
WireConnection;45;0;99;13
WireConnection;45;1;46;1
WireConnection;45;2;58;0
WireConnection;69;0;27;0
WireConnection;69;1;31;0
WireConnection;69;3;45;0
WireConnection;69;4;50;0
ASEEND*/
//CHKSM=D1EE19B48FF6EA5E7E70DB2223F7BF624AA4275B