...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.104167,0.104167,0.104167,0.000000);//Param
	Material.VectorExpressions[3] = float4(0.104167,0.104167,0.104167,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Roughness = MaterialFloat3(0.00000000,0.00000000,0.00000000).r;
