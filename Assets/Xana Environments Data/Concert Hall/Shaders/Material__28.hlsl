...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.129044,0.134689,0.952941,0.000000);//Param
	Material.VectorExpressions[3] = float4(0.129044,0.134689,0.952941,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Roughness = MaterialFloat3(0.58333331,0.58333331,0.58333331).r;
