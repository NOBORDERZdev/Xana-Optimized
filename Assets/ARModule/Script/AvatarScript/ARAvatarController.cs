...
public class ARAvatarController : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if (this.transform.childCount > 0)
        {
            ...
            {
                //If Animator Component Not Found
                ...
                if (r_isActionScene)
                {
                    Transform rootRotationObj = avatarObj.transform.Find("Hips");
                    ...
                    ARFaceModuleHandler.Instance.m_CanRotateCharacter = false;
